  ...
  <div class="grid grid-cols-1 sm:grid-cols-3 gap-4 items-end">
    <div>
      ...
      <input
        ...
        bind:value={winWidth}
        min="400"
        class="w-full rounded border border-gray-300 dark:border-gray-600 bg-white dark:bg-gray-800 text-gray-900 dark:text-gray-100 px-3 py-2 focus:outline-none focus:ring-2 focus:ring-indigo-500 subtle-placeholder"
      />
    </div>
    <div>
